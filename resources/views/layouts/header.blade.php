...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Bank</span>
    </a>
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">
                    ...
                    @endif
                    @if (!empty(Auth::guard('affiliate')->user()->id))
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                @if (!empty(Auth::guard('admin')->user()->id))
                    ...
                    <li class="nav-item">
                        <a href="{{ url('admin/affiliate/list') }}"
                            class="nav-link @if (Request::segment(2) == 'affiliate') active @endif">
                ...
                @if (!empty(Auth::guard('affiliate')->user()->id))
                    ...
                    @if (Auth::guard('affiliate')->user()->affiliate_type == 1)
                        <li class="nav-item">
                            <a href="{{ url('affiliate/sub-affiliate/list') }}"
                                class="nav-link @if (Request::segment(2) == 'sub-affiliate') active @endif">
                                <i class="nav-icon far fa-user"></i>
                                <p>
                                    Sub Affiliate
                                </p>
                    ...
                    @endif
                    <li class="nav-item">
                        <a href="{{ url('affiliate/logout') }}" class="nav-link">
                            <i class="nav-icon far fa-user"></i>
                            <p>
                                Logout
                            </p>
